        ...
        <div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
          <div className="col-span-12">
            <Card className="bg-black/20 backdrop-blur-xl shadow-lg border border-white/10 hover:shadow-xl transition-shadow rounded-2xl sm:rounded-3xl relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-white/2 via-transparent to-teal-500/3 rounded-2xl sm:rounded-3xl"></div>
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/2 to-transparent rounded-2xl sm:rounded-3xl"></div>
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-teal-500/2 to-transparent rounded-2xl sm:rounded-3xl"></div>
              
              
              <div className="absolute top-0 -right-4 bottom-0 w-3/5 sm:-right-2 sm:w-1/2 lg:right-0 lg:w-1/2 z-[2]">
                <Image
              ...
              <CardContent className="p-3 sm:p-4 md:p-6 relative z-[3]">
                  ...
                  <div className="flex space-x-4">
                    {socialLinks.map((social, index) => (
                        <a
                            ...
                            className="text-white/70 hover:text-white transition-colors duration-300 p-2 rounded-full hover:bg-white/10 backdrop-blur-sm"
                        >
                          {social.icon}
                        </a>
                    ))}
