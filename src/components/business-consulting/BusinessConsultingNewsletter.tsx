...
const BusinessConsultingNewsletter: React.FC = () => {
    ...
    <section className="py-10 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-green-950 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center relative overflow-visible md:ml-4">
            ...
            <div className="md:hidden flex flex-col items-center text-center text-white space-y-6 w-full relative z-10">
              ...
              <div className="w-full max-w-sm">
                <h2 className="text-xl font-bold mb-4">
                  Get the latest Business Consultation insights and trends.
                </h2>
...
export default BusinessConsultingNewsletter;