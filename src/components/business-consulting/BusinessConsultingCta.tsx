...
const BusinessConsultingCta: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
          <div className="col-span-12">
            <Card className="bg-green-950 shadow-lg border-none hover:shadow-xl transition-shadow rounded-2xl sm:rounded-3xl relative overflow-hidden">
              {/* Image Container - moved more to the left on mobile */}
              <div className="absolute top-0 -right-4 bottom-0 w-3/5 sm:-right-2 sm:w-1/2 lg:right-0 lg:w-1/2">
                <Image
                  src="/business/gradient-image.png"
                  alt="Illustration of global business consulting services."
                  fill
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-green-950 via-green-950/80 via-green-950/60 to-transparent pointer-events-none z-[1]"></div>
...
export default BusinessConsultingCta;