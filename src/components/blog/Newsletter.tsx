    ...
    <section className="py-10 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-[#001114] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center relative overflow-visible md:ml-4">
              ...
              <div className="flex-shrink-0">
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.onerror = null;
                    target.src =
                      "https://placehold.co/192x192/F59E0B/FFFFFF?text=📁";
                  }}
                />
              </div>
              <div className="w-full max-w-sm">
                ...
                <div className="mb-6">
                  <form onSubmit={handleSubmit} className="space-y-3 mb-4">
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-white text-[#001114] hover:bg-gray-100 h-12 rounded-full font-medium"
                      disabled={isLoading}
                    >
              ...
              <div className="absolute left-8 md:left-12 top-1/2 -translate-y-1/2 z-10">
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.onerror = null;
                    target.src =
                      "https://placehold.co/224x224/F59E0B/FFFFFF?text=📁";
                  }}
                />
              </div>
                ...
                <div className="mb-6">
                  ...
                  >
                    <div className="relative flex-grow">
                      ...
                      <Button
                        type="submit"
                        className="absolute right-2 top-1/2 -translate-y-1/2 bg-[#001114] hover:bg-gray-800 h-10 px-6 rounded-full font-medium text-white"
                        disabled={isLoading}
                      >
                        {isLoading ? "Subscribing..." : "Subscribe"}
                      </Button>
