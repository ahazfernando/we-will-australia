      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
          <div className="col-span-12">
            <Card className="bg-[#331650] shadow-lg border-none hover:shadow-xl transition-shadow rounded-2xl sm:rounded-3xl relative overflow-hidden">
              {/* Image Container - moved much further to the left on mobile */}
              ...
              {/* Purple Gradient Overlay - Minimal coverage on mobile */}
              <div className="absolute inset-0 bg-gradient-to-r from-[#331650] via-[#331650]/60 via-25% to-transparent sm:from-[#331650] sm:via-[#331650]/80 sm:via-[#331650]/60 sm:to-transparent pointer-events-none z-[1]"></div>
