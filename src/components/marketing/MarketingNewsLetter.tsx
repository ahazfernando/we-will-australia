...
const MarketingNewsletter: React.FC = () => {
    ...
    <section className="py-10 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-[#331650] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center relative overflow-visible md:ml-4">
