    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="font-semibold mb-2 leading-tight px-2 text-2xl sm:text-3xl md:text-4xl bg-gradient-to-br from-[#552586] via-[#804FB3] to-[#B589D6] bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-2">
            <Card
              className="bg-[#331650] text-white rounded-2xl shadow-2xl p-6 text-left flex flex-col justify-between transition-all duration-150 ease-out relative overflow-hidden"
              style={{
                height:
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#331650] via-[#331650] via-5% to-transparent via-20% pointer-events-none z-[1]"></div>
              ...
              >
                {faqData.map((faq, index) => (
                  <AccordionItem
                    key={index}
                    value={`item-${index}`}
                    className="bg-white shadow-lg hover:shadow-xl rounded-xl border border-gray-200/80 px-5 py-1 sm:px-6 sm:py-0 transition-all duration-200 hover:border-purple-200"
                  >
                    <AccordionTrigger className="text-base sm:text-lg font-semibold text-gray-800 text-left hover:no-underline min-h-[60px] sm:h-[52px] py-4 sm:py-0 flex items-center hover:text-purple-700 transition-colors duration-200">
                      {faq.question}
                    </AccordionTrigger>
