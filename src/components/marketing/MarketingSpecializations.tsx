...
const MarketingSpecialisations = forwardRef<HTMLElement>((props, ref) => {
  return (
      <section ref={ref} className="py-20 bg-white scroll-mt-[10px]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-semibold mb-2 leading-tight px-2 text-2xl sm:text-3xl lg:text-4xl bg-gradient-to-br from-[#552586] via-[#804FB3] to-[#B589D6] bg-clip-text text-transparent">
          ...
          <Tabs defaultValue="digital-marketing" className="w-full">
              ...
              <TabsList className="flex flex-wrap justify-center gap-2 sm:gap-3 lg:gap-4 bg-transparent h-auto p-0 max-w-full">
                {specialisations.map((spec) => (
                    <TabsTrigger
                        key={spec.tab}
                        value={spec.tab}
                        className="rounded-full px-3 py-2 sm:px-4 sm:py-2 lg:px-6 lg:py-3 text-xs sm:text-sm lg:text-base transition-all duration-300 data-[state=active]:bg-purple-700 data-[state=active]:text-white data-[state=active]:shadow-lg bg-white text-gray-700 border border-gray-300 hover:bg-purple-100 hover:border-purple-300 data-[state=inactive]:hover:bg-purple-100 whitespace-nowrap flex-shrink-0 bg-[#331650]"
                    >
                      {spec.title}
                    </TabsTrigger>
                ))}
            ...
            {specialisations.map((spec) => (
                <TabsContent key={spec.tab} value={spec.tab} className="mt-0">
                  <div className="bg-[#331650] text-white rounded-2xl shadow-2xl min-h-[300px] sm:min-h-[350px] lg:h-[368px] overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#331650] via-[#331650]/60 via-50% to-transparent z-[1]"></div>
                    <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#331650] via-[#331650]/80 via-30% to-transparent z-[2]"></div>
                    ...
                    <div className="block lg:hidden p-4 sm:p-6 relative z-10">
                      ...
                      <div className="bg-purple-400/20 p-3 sm:p-4 rounded-xl border border-purple-400/30 mb-4">
                  ...
                  <div className="flex justify-end">
                    <Link href="/contact">
                    <button className="bg-white text-purple-700 hover:bg-gray-200 px-4 sm:px-6 py-2 text-sm rounded-full font-semibold w-full">
                      Get in Touch
                    </button>
                    </Link>
                  </div>
                ...
                <div className="hidden lg:grid lg:grid-cols-2 h-full relative z-10">
                  ...
                  <div className="p-6 flex flex-col relative">
                    <div className="absolute left-0 top-6 bottom-6 w-px bg-purple-400/30"></div>
                    <div className="bg-purple-400/20 p-4 rounded-xl border border-purple-400/30 mb-4">
                      <h4 className="font-semibold text-white text-sm mb-2">
                        Why Choose {spec.title} with us?
                      </h4>
...
MarketingSpecialisations.displayName = "MarketingSpecialisations";

export default MarketingSpecialisations;