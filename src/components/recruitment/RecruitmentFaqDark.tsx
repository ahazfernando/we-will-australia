...
const RecruitmentFaqDark: React.FC = () => {
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-black">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="font-semibold mb-2 leading-tight px-2 text-2xl sm:text-3xl md:text-4xl bg-gradient-to-r from-[#3B7ED7] to-[#FFFFFF] bg-clip-text text-transparent">
              Frequently asked Questions
            </h2>
            <p className="mt-4 text-base sm:text-lg text-white/80 max-w-3xl mx-auto px-4">
              Get comprehensive answers about our recruitment services, processes, and how we can help build your team.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-6 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-2">
              <Card
                  ...
                  style={{
                    height: cardHeight && window.innerWidth >= 1024 ? `${cardHeight}px` : "auto",
                    minHeight: "300px",
                  }}
              >
                <div className="absolute top-0 -right-16 bottom-0 w-4/5 sm:-right-14 sm:w-3/5 lg:-right-12 lg:w-3/5">
                  <Image src="/about/recruitement-image.png" alt="Talk to our specialists" fill className="object-cover object-left" />
                </div>
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent pointer-events-none z-[1]"></div>
                <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-[#3B7ED7]/10"></div>

                <div className="relative z-10 pr-[50%] sm:pr-[45%] lg:pr-[50%]">
                  <h3 className="text-2xl sm:text-3xl font-bold mb-4 leading-tight">Talk to our Specialists</h3>
                ...
                <div className="relative z-10 pr-[50%] sm:pr-[45%] lg:pr-[50%]">
                  <Link href="/contact" className="inline-flex items-center justify-center rounded-lg bg-white text-black hover:bg-white/90 px-4 h-9 text-sm font-medium">
                    Contact Us
                  </Link>
                </div>
              </Card>
                ...
                <Accordion type="single" collapsible className="w-full space-y-4" onValueChange={handleAccordionChange}>
                  {faqData.map((faq, index) => (
                      <AccordionItem
                          key={index}
                          value={`item-${index}`}
                          className="bg-black/20 backdrop-blur-xl shadow-lg hover:shadow-xl rounded-xl border border-white/10 px-5 py-1 sm:px-6 sm:py-0 transition-all duration-200 hover:border-[#3B7ED7]/40"
                      >
                        <AccordionTrigger className="text-base sm:text-lg font-semibold text-white text-left hover:no-underline min-h-[60px] sm:h-[52px] py-4 sm:py-0 flex items-center hover:text-[#3B7ED7] transition-colors duration-200">
                          {faq.question}
                        </AccordionTrigger>
...
export default RecruitmentFaqDark;
